...
export default function RoomsTypeClient({ rooms, images }: { rooms: RoomType[], images: RoomImageType[] }) {
    ...
    const imagesByRoomType = images.reduce<Record<number, string[]>>((acc, img) => {
    ...
    return (
        <>
                        ...
                        >
                            ...
                            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {room.moTa && (
                                        <div className="pt-2">
                                            <h3 className="font-semibold text-gray-500 text-[11px] uppercase tracking-wider mb-1">Mô tả loại phòng</h3>
                                            <p className="text-base text-gray-600 leading-relaxed line-clamp-6 italic">{room.moTa}</p>
                                        </div>
                                    )}
                                </div>
            ...
            {editingRoom && (
                <EditRoomModal
                    room={editingRoom}
                    anhPhuExisting={imagesByRoomType[editingRoom.maLoaiPhong] || []}
